...
if (stripeSecretKey) {
  ...
  if (!stripeSecretKey.startsWith('sk_test_') && !stripeSecretKey.startsWith('sk_live_')) {
    console.warn("⚠️ Stripe key doesn't start with 'sk_test_' or 'sk_live_'");
...
if (!stripeSecretKey || stripeSecretKey.trim() === '') {
  console.error("⚠️ Creating mock Stripe instance (will fail when used)");
  ...
  try {
    ...
    // Optional: Test connection (async, won't block)
